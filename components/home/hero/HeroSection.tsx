    ...
    <section className="relative min-h-screen bg-brand-radial flex items-center justify-center overflow-hidden">
      <div className="relative z-10 text-center">
        ...
        <div
          data-aos="fade-up"
          data-aos-delay="200"
          className="text-xl sm:text-2xl md:text-3xl text-black dark:text-white font-semibold sm:mb-6 h-12"
        >
          <TypeAnimation
            sequence={[
        ...
        <p
          data-aos="fade-up"
          data-aos-delay="300"
          className="text-sm mb-4 sm:mb-8 text-gray-800 dark:text-gray-200 mx-auto max-w-prose text-center p-10"
        >
